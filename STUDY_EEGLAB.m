% This script creates a STUDY withing EGGLAB.

clear
close all

%%% Establish study directory

%home_dir='/Work/Studien/Alondra/EEG_DATA_new';
home_dir='/Volumes/alochaire_Backup_Drive/EEG_Preprocessed_SOFA/Timeptone';
home_dir2='/Volumes/alochaire_Backup_Drive/EEG_Preprocessed_SOFA/Timeptwo';
study_name='VAS_Training_Study';

folder_name='VAS_Training_Study';

eval(['mkdir /Users/alochaire/Documents/MATLAB/',char(folder_name),''])
eval(['cd /Users/alochaire/Documents/MATLAB/',char(folder_name),''])
 
%%%%%%%%%%%%%%%%%%%%%%%%%
% Name of subject; Group into: training or control
%%%%%%%%%%%%%%%%%%%%%%%%%
...
eval(['[STUDY EEG] = pop_savestudy( STUDY, EEG, ''filename'',''',char(folder_name),'.study'',''filepath'',''/Users/alochaire/Documents/MATLAB/',char(folder_name),''');'])
